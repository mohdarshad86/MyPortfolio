...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div class="social-links">
        ...
        <!-- I have did dynamic them -->
        <!-- <a href="<?= $data['facebook'] ?>" target="balnk" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="<?= $data['instagram'] ?>" target="balnk" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="<?= $data['linkedin'] ?>" target="balnk" class="linkedin"><i class="bi bi-linkedin"></i></a>
        <a href="<?= $data['github'] ?>" target="balnk" class="linkedin"><i class="bi bi-github"></i></a>
        <a href="<?= $data['youtube'] ?>" target="balnk" class="linkedin"><i class="bi bi-youtube"></i></a> -->
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <?php echo date('d M Y', strtotime($data['birthday'])) ?><span></span></li>
      ...
      <div class="row">
        ...
        ?>
            <div class="col-lg-3 col-md-4">
              <div class="icon-box">
                <i class="<?= $skills_rows['icon'] ?>" style="color: #<?= $skills_rows['color'] ?>;"></i>
                <h3><?= $skills_rows['title'] ?></h3>
              </div>
            </div>
        <?php
          }
  ...
  <div class="credits">
    ...
    $deatails_result = mysqli_query($con, $details);
    $deatails_data = mysqli_fetch_assoc($deatails_result);
    ...
    Designed by <a href="<?= $deatails_data['url'] ?>" target="blank"><?= $deatails_data['company']  ?></a>
  </div>
